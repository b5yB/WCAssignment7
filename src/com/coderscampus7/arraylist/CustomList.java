...
public interface CustomList<T> {
	 ...
	 * specified index (thus shifting the other items to the right). If it doesn't 
	 ...
	 * item was removed, instead all other items to the right will be shifted to the left.
